---
name: "ppk-setup"
description: Sets up Prototype Parity Kit module in a project. Use when the user requests to 'install ppk module', 'configure Prototype Parity Kit', or 'setup Prototype Parity Kit'.
---
...
3. Check for per-module configuration at `{project-root}/_bmad/ppk/config.yaml` and `{project-root}/_bmad/core/config.yaml`. If either file exists:
...
python3 ./scripts/merge-help-csv.py --target "{project-root}/_bmad/module-help.csv" --source ./assets/module-help.csv --legacy-dir "{project-root}/_bmad" --module-code ppk
```
...
```bash
python3 ./scripts/cleanup-legacy.py --bmad-dir "{project-root}/_bmad" --module-code ppk --also-remove _config --skills-dir "{project-root}/.claude/skills"
```
